...
function renderLanding(raw, templateHtml, rawDataBase64, bg, hsize, psize, tColor, bColor) {
    const product = mapJsonToProduct(raw);
    const selectedTemplate = templateHtml && templates[templateHtml] ? templates[templateHtml] : templates.modern;
...
// /app/api/landing-html/[slug]/route.ts
/* __next_internal_action_entry_do_not_use__ [{"60f4bc314bf7ddc6bbc2cf5bbcc56f448102c16254":"GET"},"",""] */ __turbopack_context__.s([
    "GET",
    ()=>GET
]);
...
async function GET(req, { params }) {
    try {
        ...
        if (!productData) {
            return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](`<h1>Product Not Found</h1>`, {
                status: 404,
                headers: {
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](`<h1>Server Error</h1><pre>${error.message}</pre>`, {
            status: 500
        });
    }
}
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["registerServerReference"])(GET, "60f4bc314bf7ddc6bbc2cf5bbcc56f448102c16254", null);
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__c6904da3._.js.map