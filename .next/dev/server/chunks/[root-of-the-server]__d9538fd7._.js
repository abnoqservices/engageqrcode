...
"[project]/server/cards.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/server/cards.ts [app-route] (ecmascript)"); // imports all exported card strings
;
;
;
console.log("CARDS loaded:", Object.keys(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__));
...
function mapJsonToProduct(json) {
    return {
        ...
        images: json.images?.map((i)=>i.url) || [],
...
function renderLanding(raw, templateHtml, bg, hsize, psize, tColor, bColor, rawDataBase64) {
    ...
    const globalCssInjected = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.GLOBAL_CSS, {
        primaryColor: (fullData?.styles?.primaryColor || bColor || "061244").replace("#", ""),
        backgroundColor: (fullData?.styles?.backgroundColor || bg || "ffffff").replace("#", ""),
        textColor: (fullData?.styles?.textColor || tColor || "000000").replace("#", ""),
        hsize: fullData?.styles?.headlineSize || hsize || 28,
        psize: fullData?.styles?.paragraphSize || psize || 16
    });
    ...
    if (fullData && Array.isArray(fullData.sections)) {
        ...
        for (const sec of enabled){
            ...
            switch(placeholder){
                case "{{meta_seo}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.Meta_SEO_CARD, dynamicValues);
                    break;
                case "{{top_slider_card}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.TOP_SLIDER_CARD, dynamicValues);
                    break;
                case "{{top_slider_card_tow}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.TOP_SLIDER_CARD_TOW, dynamicValues);
                    break;
                case "{{about_brand}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.ABOUT_BRAND_CARD, dynamicValues);
                    break;
                case "{{product_spotlight}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.PRODUCT_SPOTLIGHT_CARD, dynamicValues);
                    break;
                case "{{specifications}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.SPECS_CARD, dynamicValues);
                    break;
                case "{{our_collection}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.OUR_COLLECTION_CARD, dynamicValues);
                    break;
                case "{{youtube}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.YOUTUBE_CARD, dynamicValues);
                    break;
                case "{{featured_products}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.FEATURED_PRODUCTS_CARD, dynamicValues);
                    break;
                case "{{join_club}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.JOIN_BEAUTY_CLUB_CARD, dynamicValues);
                    break;
                case "{{natural_ingredients}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.NATURAL_INGREDIENTS_CARD, dynamicValues);
                    break;
                case "{{social_media}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.SOCIAL_MEDIA_CARD, dynamicValues);
                    break;
                case "{{contact}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.CONTACT_CARD, dynamicValues);
                    break;
                case "{{rate_experience}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.RATE_EXPERIENCE_CARD, dynamicValues);
                    break;
                case "{{header_logo_card}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.HEADER_LOGO_CARD, dynamicValues);
                    break;
                case "{{header_logo_card_tow}}":
                    cardHtml = applyTemplate(__TURBOPACK__imported__module__$5b$project$5d2f$server$2f$cards$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__.HEADER_LOGO_CARD_TOW, dynamicValues);
                    break;
                default:
                    cardHtml = "";
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d9538fd7._.js.map