module.exports = [
"[project]/components/tempcomponent/Specification.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function Specification() {
    // You can replace these with real product data or pass as props
    const specs = [
        {
            label: 'Processor',
            value: 'Intel Core i7-13700K (13th Gen)'
        },
        {
            label: 'RAM',
        ...
        {
            label: 'Graphics Card',
            value: 'NVIDIA GeForce RTX 4070 12GB'
        },
        {
            label: 'Display',
            value: '15.6" 4K OLED 120Hz Touchscreen'
        },
        {
            label: 'Battery Life',
        ...
        {
            label: 'Ports',
            value: '2x USB-C Thunderbolt 4, 3x USB-A, HDMI 2.1, SD Card'
        },
        {
            label: 'Warranty',
            value: '2 Years + 1 Year Accidental Damage Protection'
        }
    ];
...
//# sourceMappingURL=components_tempcomponent_Specification_tsx_44a9f370._.js.map