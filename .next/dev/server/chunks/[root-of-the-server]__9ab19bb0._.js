...
async function GET(req, { params }) {
    try {
        ...
        const templateName = url.searchParams.get("template") || "modern";
        const rawData = url.searchParams.get("data") || null;
        const slug = 1;
        ...
        return new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"](`<html><body><h1>500 Internal Server Error</h1>
       <p>Failed to generate landing page.</p></body></html>`, {
            status: 500,
            headers: {
                "Content-Type": "text/html"
            }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__9ab19bb0._.js.map