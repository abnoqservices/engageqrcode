...
"[project]/app/landing-pages/[slug]/page.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LandingPageBuilder() {
    ...
    const [savedData, setSavedData] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](null);
    const [loading, setLoading] = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"](isEditMode);
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "LandingPageBuilder.useEffect": ()=>{
            if (isEditMode) {
                ...
                }["LandingPageBuilder.useEffect"], 800);
            }
        }
    }["LandingPageBuilder.useEffect"], [
        slug,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"]({
        "LandingPageBuilder.useEffect": ()=>{
            if (savedData && !loading) {
                ...
                const loadedSections = savedData.sections.map({
                    "LandingPageBuilder.useEffect.loadedSections": (saved)=>{
                        const template = AVAILABLE_SECTIONS.find({
                            "LandingPageBuilder.useEffect.loadedSections.template": (s)=>s.section === saved.section
                        }["LandingPageBuilder.useEffect.loadedSections.template"]);
                        return {
                ...
                }["LandingPageBuilder.useEffect.loadedSections"]);
                setActiveSections(loadedSections);
                setStyles({
                    "LandingPageBuilder.useEffect": (prev)=>({
                            ...prev,
                            ...savedData.styles
                        })
                }["LandingPageBuilder.useEffect"]);
                ...
                setActiveSections([
                    {
                        section: "Header",
                        enabled: true,
                        fields: AVAILABLE_SECTIONS.find({
                            "LandingPageBuilder.useEffect": (s)=>s.section === "Header"
                        }["LandingPageBuilder.useEffect"]).fields
                    },
                    {
                        section: "Description",
                        enabled: true,
                        fields: AVAILABLE_SECTIONS.find({
                            "LandingPageBuilder.useEffect": (s)=>s.section === "Description"
                        }["LandingPageBuilder.useEffect"]).fields
                    },
                    {
                        section: "CTA",
                        enabled: true,
                        fields: AVAILABLE_SECTIONS.find({
                            "LandingPageBuilder.useEffect": (s)=>s.section === "CTA"
                        }["LandingPageBuilder.useEffect"]).fields
                    }
                ]);
            }
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["Card"], {
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$card$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["CardContent"], {
                                            children: activeSections.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s1(LandingPageBuilder, "rKYm3YMJ/4LJwflDsREW84zfYOU=", false, function() {
    return [
...
_c1 = LandingPageBuilder;
var _c, _c1;
__turbopack_context__.k.register(_c, "SortableItem");
__turbopack_context__.k.register(_c1, "LandingPageBuilder");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=_54964a83._.js.map